...
These apps can generate a username and password that work just like SMTP username/password, except that it handles this request just like an ACS resource.
